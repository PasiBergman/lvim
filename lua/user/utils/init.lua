...
utils.get_debug_program = function()
  local dap_config = require("user.utils").decode_json_file(vim.fn.getcwd() .. "/.dap.json")
  ...
  local vimspector_config = require("user.utils").decode_json_file(vim.fn.getcwd() .. "/.vimspector.json")
